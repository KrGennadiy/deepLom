...
(1, 4, 1, 1, 2, '80088080', '1', 2, 0),
(2, 4, 1, 2, 1, '1355', '2', 3, 0),
(3, 3, 1, 1, 2, '84569456', '2', 3, 0),
(4, 1, 2, 1, 2, '10111', '1', 2, 0),
(5, 5, 2, 2, 1, '10223', '1', 1, 0);
...
INSERT INTO `typeplan` (`idTypePlan`, `titleTypePlan`) VALUES
(1, 'Первый тестовый тип плана'),
(2, 'Второй тестовый тип плана');
...
--
ALTER TABLE `serviceman`
  MODIFY `idServiceman` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `typeplan`
  MODIFY `idTypePlan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
